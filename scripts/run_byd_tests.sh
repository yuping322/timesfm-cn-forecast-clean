...
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 1 --adapter data/research/adapters/byd_basic_3m_t1.pth > data/research/adapters/eval_basic_3m_t1.log 2>&1
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 1 --adapter data/research/adapters/byd_technical_3m_t1.pth > data/research/adapters/eval_technical_3m_t1.log 2>&1
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 1 --adapter data/research/adapters/byd_structural_3m_t1.pth > data/research/adapters/eval_structural_3m_t1.log 2>&1
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 1 --adapter data/research/adapters/byd_full_3m_t1.pth > data/research/adapters/eval_full_3m_t1.log 2>&1
...
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 5 --adapter data/research/adapters/byd_basic_2y_t5.pth > data/research/adapters/eval_basic_2y_t5.log 2>&1
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 5 --adapter data/research/adapters/byd_technical_2y_t5.pth > data/research/adapters/eval_technical_2y_t5.log 2>&1
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 5 --adapter data/research/adapters/byd_structural_2y_t5.pth > data/research/adapters/eval_structural_2y_t5.log 2>&1
python -m timesfm_cn_forecast.backtest --symbol 002594 --test-days 20 --horizon 5 --adapter data/research/adapters/byd_full_2y_t5.pth > data/research/adapters/eval_full_2y_t5.log 2>&1
